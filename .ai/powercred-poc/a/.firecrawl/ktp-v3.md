[Jump to Content](https://apidocs.powercred.io/reference/method_get_ocr_ktp_v3_post#content)
...
[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/method_get_ocr_ktp_v3_post) [![PowerCred](https://files.readme.io/13f1989-image_5_1.svg)](https://apidocs.powercred.io/reference)

API Reference

[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/method_get_ocr_ktp_v3_post)
...
2. [/identity/get/ocr/ktp/v3](https://apidocs.powercred.io/reference/identitygetocrktpv3)
...
https://mock.powercred.io/identity/get/ocr/ktp/v3
...
[Skip link to Query Params](https://apidocs.powercred.io/reference/method_get_ocr_ktp_v3_post#query-params) Query Params
...
[Skip link to Body Params](https://apidocs.powercred.io/reference/method_get_ocr_ktp_v3_post#body-params) Body Params
...
[Skip link to Responses](https://apidocs.powercred.io/reference/method_get_ocr_ktp_v3_post#response-schemas) Responses
...
[/identity/get/ocr/ktp/v3](https://apidocs.powercred.io/reference/identitygetocrktpv3) [FaceMatch & Liveness](https://apidocs.powercred.io/reference/identitygetliveness-facematch)
...
curl --request POST \
     ...
     --url https://mock.powercred.io/identity/get/ocr/ktp/v3 \
