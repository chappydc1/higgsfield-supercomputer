[Jump to Content](https://apidocs.powercred.io/reference/method_stmt_upload_post#content)
...
[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/method_stmt_upload_post) [![PowerCred](https://files.readme.io/13f1989-image_5_1.svg)](https://apidocs.powercred.io/reference)

API Reference

[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/method_stmt_upload_post)
...
Upload Bank statements in PDF format or process JPG/PNG format
...
2. [Upload bank statement(s) in PDF/JPG/PNG format](https://apidocs.powercred.io/reference/upload-bank-statements-in-pdfjpgpng-format)
...
https://mock.powercred.io/bank/analysis/stmt/upload
...
Create a session ID using [Get Token API](https://powercred.readme.io/reference/post_auth-token) and pass the ID in the ID field below.

[Skip link to Query Params](https://apidocs.powercred.io/reference/method_stmt_upload_post#query-params) Query Params
...
[Skip link to Body Params](https://apidocs.powercred.io/reference/method_stmt_upload_post#body-params) Body Params
...
[Skip link to Responses](https://apidocs.powercred.io/reference/method_stmt_upload_post#response-schemas) Responses
...
[Upload Bank statements in JPG/PNG format](https://apidocs.powercred.io/reference/method_stmt_upload_img_post) [Start the bank statement analysis](https://apidocs.powercred.io/reference/start-the-bank-statement-analysis)
...
curl --request POST \
     ...
     --url https://mock.powercred.io/bank/analysis/stmt/upload \
