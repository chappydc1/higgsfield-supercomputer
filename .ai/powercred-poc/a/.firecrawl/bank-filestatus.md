[Jump to Content](https://apidocs.powercred.io/reference/get_file_status_analysis_filestatus_get#content)
...
[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/get_file_status_analysis_filestatus_get) [![PowerCred](https://files.readme.io/13f1989-image_5_1.svg)](https://apidocs.powercred.io/reference)

API Reference

[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/get_file_status_analysis_filestatus_get)
...
Get the processing status of all the uploaded bank statement(s)
...
2. [Get processing status](https://apidocs.powercred.io/reference/get-processing-status)
...
https://mock.powercred.io/bank/analysis/filestatus
...
[Skip link to Query Params](https://apidocs.powercred.io/reference/get_file_status_analysis_filestatus_get#query-params) Query Params
...
[Skip link to Responses](https://apidocs.powercred.io/reference/get_file_status_analysis_filestatus_get#response-schemas) Responses
...
[Start the bank statement analysis process](https://apidocs.powercred.io/reference/method_stmt_publish_post) [Get analyzed statements output](https://apidocs.powercred.io/reference/get-analyzed-statements-output)
...
curl --request GET \
     ...
     --url 'https://mock.powercred.io/bank/analysis/filestatus?bank_name=multi_bank_ocr' \
