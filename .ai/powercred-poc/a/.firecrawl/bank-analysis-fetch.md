[Jump to Content](https://apidocs.powercred.io/reference/get_analysis_details_transactions_analysis_fetch_get#content)
...
[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/get_analysis_details_transactions_analysis_fetch_get) [![PowerCred](https://files.readme.io/13f1989-image_5_1.svg)](https://apidocs.powercred.io/reference)

API Reference

[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/get_analysis_details_transactions_analysis_fetch_get)
...
Get bank statement analysis and tamper checks outputs in json format.
...
2. [Get analyzed statements output](https://apidocs.powercred.io/reference/get-analyzed-statements-output)
...
https://mock.powercred.io/bank/transactions/analysis/fetch
...
[Skip link to Query Params](https://apidocs.powercred.io/reference/get_analysis_details_transactions_analysis_fetch_get#query-params) Query Params
...
multi\_bank\_ocrBCAMANDIRIBRIBNIOCBCPERMATACIMBMAYBANK

Show 9 enum values

[Skip link to Responses](https://apidocs.powercred.io/reference/get_analysis_details_transactions_analysis_fetch_get#response-schemas) Responses
...
[Get bank statement account, transactions, credit, debit and overview outputs in json format.](https://apidocs.powercred.io/reference/get_transactions_details_transactions_fetch_get) [Get bank statement raw analysis output in excel format.](https://apidocs.powercred.io/reference/get_bank_excels_analysis_statement_get)
...
curl --request GET \
     ...
     --url 'https://mock.powercred.io/bank/transactions/analysis/fetch?bank_name=multi_bank_ocr' \
