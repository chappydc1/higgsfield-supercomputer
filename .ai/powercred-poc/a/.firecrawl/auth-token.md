[Jump to Content](https://apidocs.powercred.io/reference/post_auth-token#content)
...
[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/post_auth-token) [![PowerCred](https://files.readme.io/13f1989-image_5_1.svg)](https://apidocs.powercred.io/reference)

API Reference

[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/post_auth-token)
...
http://mock.powercred.io/auth/token
...
[Skip link to Query Params](https://apidocs.powercred.io/reference/post_auth-token#query-params) Query Params
...
[Skip link to Body Params](https://apidocs.powercred.io/reference/post_auth-token#body-params) Body Params

user\_id field in the request body is mandatory
...
[Skip link to Response](https://apidocs.powercred.io/reference/post_auth-token#response-schemas) Response
...
[Create Session ID](https://apidocs.powercred.io/reference/default) [Introduction to IDP](https://apidocs.powercred.io/reference/introduction-to-idp)
...
curl --request POST \
     ...
     --url http://mock.powercred.io/auth/token \
