[Jump to Content](https://apidocs.powercred.io/reference/method_get_get#content)
...
[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/method_get_get) [![PowerCred](https://files.readme.io/13f1989-image_5_1.svg)](https://apidocs.powercred.io/reference)

API Reference

[Log In](https://apidocs.powercred.io/login?redirect_uri=/reference/method_get_get)
...
2. [Document Parsing API](https://apidocs.powercred.io/reference/idpread)
...
https://mock.powercred.io/idp/get
...
[Skip link to Query Params](https://apidocs.powercred.io/reference/method_get_get#query-params) Query Params
...
[Skip link to Responses](https://apidocs.powercred.io/reference/method_get_get#response-schemas) Responses
...
[Start Parsing](https://apidocs.powercred.io/reference/method_read_post) [Insights API](https://apidocs.powercred.io/reference/digitalinsightstelco)
...
curl --request GET \
     ...
     --url 'https://mock.powercred.io/idp/get?return_json=false' \
